...
const filterUserProfile = async(req,res)=>{
  ...
  if(req.query.keyword){
    ...
    var getUserData = await userData.find({$or:[{userName : Keyword}, {designation : Keyword},{skill : Keyword},{about : Keyword},{location : Keyword} ]})
  }
  if(req.query.keywords){
    var getUserData = await userData.find({$and:[{userName : userName}, {designation : designation},{about : {$exists:true}},{location : location} ]})
  }
